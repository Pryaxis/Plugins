...
* [TShock Chinese Plugin Collection | TShock中文插件搜集仓库](https://github.com/UnrealMultiple/TShockPlugin) by [UnrealMultiple](https://github.com/UnrealMultiple)
  ...
  * [Download](https://github.com/UnrealMultiple/TShockPlugin/releases/tag/V1.0.0.0)
  * [Download Mirror](https://gitee.com/kksjsj/TShockPlugin/releases/download/V1.0.0.0/Plugins.zip)
  * [Documentation](https://github.com/UnrealMultiple/TShockPlugin/blob/master/README.md)
  * [Source code](https://github.com/UnrealMultiple/TShockPlugin)
* [AutoTeam](https://github.com/TerraTrapezium/AutoTeam) by [Metacinnabar](https://github.com/Metacinnabar)
  ...
  * [Download Version 1.0.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/AutoTeam/AutoTeam-1.0.0.dll) (`AutoTeam.dll`)
...
* [IRCrarria](https://github.com/lemon-sh/IRCrarria) by lemon-sh
  ...
  * Tested on TShock 4.5.5.
  * [Download Version 1.2.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/IRCRarria/IRCrarria-1.2.0.zip)
...
* [MultiSCore](https://github.com/Megghy/MultiSCore/releases/) by Megghy
  ...
  * Tested on TShock 4.5.5
  * [Download Version 1.5.4](https://tshock.s3.us-west-001.backblazeb2.com/tshock/MultiScore/MultiSCore-1.5.4.dll)
...
* [TerrariaChatRelay](https://github.com/xNarnia/TCR-TerrariaChatRelay) by [Narnia (Panini)](https://github.com/xNarnia)
  ...
  * [Download Version 2.3.0.4 for TShock 5.2.1](https://files.catbox.moe/olxzt8.zip)
...
* [WorldMapper](https://github.com/drunderscore/WorldMapper) by Dr. Underscore
  ...
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/WorldMapper/WorldMapper-1.0.0.zip)
...
* JourneyMixer
  ...
  * Download https://tshock.s3.us-west-001.backblazeb2.com/tshock/JourneyMixer/JourneyMixer.dll
* InfiniteChestsV3 by Zaicon
  ...
  * [Download Version 1.3.0.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/InfiniteChestsV3/InfiniteChests-1.3.0.0.dll)
...
* ZAdminCmds
  ...
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/ZAdminCmds/ZAdminCmds.dll)
...
* [Crossplay](https://github.com/Moneylover3246/Crossplay) by Moneylover3246
  ...
  * [Download v1.7.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/Crossplay/Crossplay-1.7.0.dll)
...
* AdvancedWarpplates
  ...
  * Tested on TShock 4.4.0 Pre-10.
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/AdvancedWarpplates/AdvancedWarpplates.dll)
...
* ShortCommands
  ...
  * Tested on TShock 4.4.0 Pre-10.
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/ShortCommands/ShortCommands.dll)
  * [Source code](https://github.com/Rustly/ShortCommands)
* CloneNotify
  * Zaicon's CloneNotify updated to 1.4. (https://github.com/Zaicon/CloneNotify)
  * Tested on TShock 4.4.0 Pre-10.
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/CloneNotify/CloneNotify.dll)
...
* CustomMediumcore by Miffyli
  ...
  * [Download Version 1.4.0.1](https://tshock.s3.us-west-001.backblazeb2.com/tshock/CustomMediumcore/CustomMediumcore-1.4.0.1.zip)
...
* Tiled by thanatos-tshock
  ...
  * Tested on TShock 4.4.0 Pre-3.
  * [Download Version 1.4.0.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/Tiled/Tiled-1.4.0.0.dll)
...
* FACommands by MineBartekSA
  ...
  * [Download Version 1.7.1](https://tshock.s3.us-west-001.backblazeb2.com/tshock/FACommands/FACommands-1.7.1.dll)
...
* [Terracord](https://github.com/FragLand/terracord) by [ldilley](https://github.com/ldilley)
  ...
  * Tested on TShock 4.5.5.
  * [Download Version 1.3.1](https://tshock.s3.us-west-001.backblazeb2.com/tshock/Terracord/TerraCord-1.3.1.zip)
...
* TerraJump by MineBartekSA
  ...
  * [Download Version 2.3.1](https://tshock.s3.us-west-001.backblazeb2.com/tshock/TerraJump/TerraJump-2.3.1.dll)
...
* [Invincible Tiles (and walls)](https://github.com/Olink/Invincible-Tiles) by Olink
  ...
  * [Download Version 1.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/InvincibleTiles/InvincibleTiles-1.0.0.dll)
...
* [TServerWeb - Online Server Manager for TShock](https://www.tserverweb.com/) by XGhozt
  ...
  * Addon: [TServerWeb In-Game Vote Plugin](https://tshock.s3.us-west-001.backblazeb2.com/tshock/TServerWeb/TSWVote.dll) / [Source Code](https://gitlab.xghozt.com:2345/tsw/TSWVote)
  * Addon: [TServerWeb Remote Console](https://tshock.s3.us-west-001.backblazeb2.com/tshock/TServerWeb/TSWConsole.dll) / [Source Code](https://gitlab.xghozt.com:2345/tsw/tswconsole)
...
* Vanillafier
  ...
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/Vanillafier/Vanillafier-1.0.0.zip)
...
* [Creative Mode](https://tshock.co/xf/index.php?resources/creative-mode.19/) by Bippity
  ...
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/CreativeMode/CreativeMode.dll)
...
* [TDiffBackup](https://github.com/tieonlinux/TDiffBackup) by [tieonlinux](https://github.com/tieonlinux)
  ...
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/TDiffBackup/TDiffBackup.zip)
...
* [ShortCommands](https://github.com/tieonlinux/ShortCommands) by [Zaicon](https://github.com/Zaicon), updated by [tieonlinux](https://github.com/tieonlinux)
  ...
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/ShortCommands/fork/ShortCommands-tieonlinux-fork.zip)
...
* [Team Commands](https://github.com/ZakFahey/Team-Commands) by GameRoom
  ...
  * Built on TShock 4.4.0 Pre-8
  * [Download Version 1.2](https://tshock.s3.us-west-001.backblazeb2.com/tshock/TeamCommands/TeamCommands-1.2.dll)
...
* [Smart Regions](https://github.com/ZakFahey/SmartRegions) by GameRoom
  ...
  * [Download Version 1.3.1](https://tshock.s3.us-west-001.backblazeb2.com/tshock/SmartRegions/SmartRegions-1.3.1.dll)
...
* [Normal Boss Bags](https://github.com/Quinci135/NormalBossBags) by Quinci
  ...
  * [Download Version 1.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/NormalBossBags/NormalBossBags-1.0.zip)
...
* [AFK Warp/Kick Plugin](https://tshock.co/xf/index.php?resources/afk-warp-kick.104/) by Bippity
  ...
  * [Download Version 1.1](https://tshock.s3.us-west-001.backblazeb2.com/tshock/AFKWarp/AFKWarp-1.1.zip)
...
* [Buff Emoticons](https://github.com/Dylanswaggerino/Buff-Emotions) by The Killer [NL]
  ...
  * Tested on TShock 4.4.0 Pre-15.
  * [Download Version 2.1](https://tshock.s3.us-west-001.backblazeb2.com/tshock/BuffEmoticons/BuffEmoticons-2.1.dll)
...
* [ListPluginsPlugin](https://github.com/Arthri/ListPluginsPlugin) by Arthri
  ...
  * Tested on TShock 4.5.5
  * [Download Version 1.0.1](https://tshock.s3.us-west-001.backblazeb2.com/tshock/ListPluginsPlugin/ListPluginsPlugin-1.0.dll)
...
* [TemplateMOTDPlugin](https://github.com/Arthri/TemplateMOTDPlugin) by Arthri
  ...
  * Tested on TShock 4.5.5
  * [Download Version 1.0.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/TemplateMOTDPlugin/TemplateMOTDPlugin-1.0.0.zip)
...
* [Character Reset (SSC)](https://github.com/bippity/CharacterReset) by [Bippity](https://github.com/bippity), updated by [moisterrific](https://github.com/moisterrific)
  ...
  * [Download Version 1.0.3](https://tshock.s3.us-west-001.backblazeb2.com/tshock/ResetSSC/ResetSSC-1.0.3.zip)
...
* [Ghost](https://github.com/DannyDan77/Ghost) by [DannyDan77](https://github.com/DannyDan77), updated by [moisterrific](https://github.com/moisterrific)
  ...
  * Built and tested on TShock 4.4.0 Pre-11.
  * [Download Version 1.2.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/Ghost/Ghost-1.2.0.zip)
...
* [InfiniteChestsV3](https://github.com/Zaicon/InfiniteChestsV3) by [Zaicon](https://github.com/Zaicon), updated by [moisterrific](https://github.com/moisterrific)
  * Allows "infinite" chests and additional features such as auto-refill, password-protected chests, and more.
  * Built and tested on TShock 4.5.2.0 (April Lyrids edition).
  * [Download Version 1.2.1](https://tshock.s3.us-west-001.backblazeb2.com/tshock/InfiniteChests/InfiniteChests-1.2.1.zip)
...
* [Calculator](https://github.com/edg-l/Calculator) by [edg-l](https://github.com/edg-l)
  * A calculator plugin.
  * Built on TShock 4.4.0 Pre-11.
  * [Download 1.0.0.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/Calculator/Calculator-1.0.0.0.zip)
...
* [PlayerInfo](https://github.com/Brycey92/PlayerInfo/tree/terraria-1.4) by [ParadonX](https://github.com/ParadonX), updated by [Brycey92](https://github.com/Brycey92)
  ...
  * Built on TShock 4.4.0 Pre-11.
  * [Download 1.8](https://tshock.s3.us-west-001.backblazeb2.com/tshock/PlayerInfo/PlayerInfo-1.8.zip)
...
* [SummonLimit](https://github.com/moisterrific/SummonLimit) by [Newy](https://github.com/newyrose), updated by [moisterrific](https://github.com/moisterrific)
  ...
  * Built on TShock 4.4.0 Pre-11.
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/SummonLimit/SummonLimit.zip)
...
* [TshockLogs_Explosives](https://github.com/moisterrific/TshockLogs_Explosives) by [slzn](https://github.com/slzn), updated by [moisterrific](https://github.com/moisterrific)
  ...
  * Built on TShock 4.4.0 Pre-11.
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/TShockLogs_Explosives/TShockLogs_Explosives.zip)
...
* [WorldEdit](https://github.com/Brycey92/WorldEdit)
  ...
  * Built on TShock 4.4.0 Pre-11.
  * [Download 1.8.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/WorldEdit/fork/WorldEdit.zip)
...
* [RodHealer](https://github.com/ancientgods/RodHealer) by [ancientgods](https://github.com/ancientgods), updated by [moisterrific](https://github.com/moisterrific)
  ...
  * Built and tested on TShock 4.4.0 Pre-11.
  * [Download Version 1.2.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/RodHealer/RodHealer-1.2.0.zip)
...
* [World Refill](https://github.com/k0rd/WorldRefill) by [K0rd](https://github.com/k0rd), updated by [Illuminousity](https://github.com/Illuminousity)
  ...
  * Built and tested on Tshock 4.4.0 Pre-11.
  * [Download Version 2.1.3](https://tshock.s3.us-west-001.backblazeb2.com/tshock/WorldRefill/WorldRefill.zip)
...
* [Auto Team](https://github.com/dredhorse/tShockAutoTeam) by Don Redhorse
   ...
   * Tested on TShock 4.4.0 Pre-12.
   * [Download Version 1.0.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/AutoTeam/fork/AutoTeam-1.0.0.dll)
...
* [TShockPrometheus](https://github.com/swantzter/tshock-prometheus) by [Swantzter](https://github.com/swantzter)
  ...
  * Tested on TShock 4.4.0 Pre-15.
  * [Download Version 1.0.0](https://tshock.s3.us-west-001.backblazeb2.com/tshock/TShockPrometheus/TShockPrometheus-1.0.0.zip)
...
* [Essentials+](https://github.com/QuiCM/EssentialsPlus) by [QuiCM](https://github.com/QuiCM) (and various others <3)
  ...
  * [Download](https://tshock.s3.us-west-001.backblazeb2.com/tshock/EssentialsPlus/EssentialsPlus.dll)
